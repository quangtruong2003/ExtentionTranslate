...
assert.match(panelSource, /copyToClipboard\(phase\.sourceText, setCopiedOriginal\)/);
assert.match(panelSource, /copyToClipboard\(phase\.translatedText, setCopiedTranslation\)/);
