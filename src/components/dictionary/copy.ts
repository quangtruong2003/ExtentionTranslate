...
const ERROR_COPY: Record<TargetLanguage, Record<string, string>> = {
  en: {
    ...
    TRUNCATED_RESPONSE: "The AI response was cut off by the token limit. Please try again.",
  ...
  vi: {
    ...
    TRUNCATED_RESPONSE: "Phản hồi AI bị cắt do giới hạn token. Vui lòng thử lại.",
  ...
  "zh-CN": {
    ...
    TRUNCATED_RESPONSE: "AI 回复因 token 限制被截断，请重试。",
