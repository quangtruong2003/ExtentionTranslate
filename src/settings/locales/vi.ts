...
export const vi: SettingsCopy = {
  ...
  toeicIntervalDescription: "Số phút hoạt động trước khi quiz xuất hiện (5–120 phút).",
  toeicIntervalSuffix: "phút",
  toeicCountTitle: "Số câu hỏi",
  toeicCountDescription: "Số câu hỏi trong mỗi bài quiz (3–20 câu).",
  toeicCountSuffix: "câu",
  toeicTimeNote: "Thời gian làm bài: 30 giây mỗi câu (cố định). Bạn phải đọc hết giải thích trước khi đóng.",
};
