...
export const zhCN: SettingsCopy = {
  ...
  toeicIntervalTitle: "累计时间",
  toeicIntervalDescription: "测验出现前的活动分钟数（5–120 分钟）。",
  toeicIntervalSuffix: "分钟",
  toeicCountTitle: "题目数量",
  toeicCountDescription: "每次测验的题目数（3–20 题）。",
  toeicCountSuffix: "题",
  toeicTimeNote: "答题时间：每题 30 秒（固定）。关闭前必须读完所有解释。",
};
